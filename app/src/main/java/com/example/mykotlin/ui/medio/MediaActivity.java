package com.example.mykotlin.ui.medio;
...
import com.example.mykotlin.view.MovieView;
...
public class MediaActivity extends AppCompatActivity {
    ...
    void updatePictureInPictureActions(
        ...
        final PendingIntent intent =
                PendingIntent.getBroadcast(
                        ...
                        0);
        @SuppressLint({"NewApi", "LocalSuppress"}) final Icon icon = Icon.createWithResource(MediaActivity.this, iconId);
        actions.add(new RemoteAction(icon, title, title, intent));

        // Another action item. This is a fixed action.
        actions.add(
                new RemoteAction(
                        Icon.createWithResource(MediaActivity.this, R.drawable.ic_info_24dp),
    ...
    void minimize() {
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) Rational aspectRatio = new Rational(mMovieView.getWidth(), mMovieView.getHeight());
